    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={{ marginVertical: 8, padding: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <View>
            <Image style={{ width: 70, height: 70, borderRadius: 6, marginEnd: 8 }} source={require('../../../media/pictures/health.jpg')} />
          </View>
        ...
        <View style={{ marginVertical: 8, padding: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <View>
            <Image style={{ width: 70, height: 70, borderRadius: 6, marginEnd: 8 }} source={require('../../../media/pictures/technology.jpg')} />
          </View>
          <View style={{ width: 180, paddingEnd: 20 }}>
